...
public class Loan {
	...
	//uses FinanceLib.pmt() to find PMT
	public double GetPMT() {
		double PMT = 0;
		PMT = Math.abs(FinanceLib.pmt(this.InterestRate/12, this.LoanPaymentCnt, this.LoanAmount, 0, this.bCompoundingOption));
		return PMT;
	}

	public double getTotalPayments() {
		//for loop sum of payments
		int num = 0;
		double tot = 0;
